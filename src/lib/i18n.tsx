...
const en = {
	...
	"import.browserHint": "Chrome / Edge: Bookmark manager → ⋮ → Export bookmarks. Firefox: Library → Import and Backup → Export Bookmarks to HTML. Safari: File → Export Bookmarks.",
	"import.browserFile": "Choose HTML file",
	"import.browserEmpty": "No bookmarks found in this file.",
	"import.run": "Import",
...
const zh: Record<string, string> = {
	...
	"import.file": "选择文件",
	"import.browser": "导入浏览器书签",
	"import.browserHint": "Chrome / Edge：书签管理器 → 右上角 ⋮ → 导出书签。Firefox：书签 → 管理书签 → 导入和备份 → 将书签导出为 HTML。Safari：文件 → 导出书签。",
	"import.browserFile": "选择 HTML 文件",
	"import.browserEmpty": "这个文件里没有解析到书签。",
	"import.run": "导入",
